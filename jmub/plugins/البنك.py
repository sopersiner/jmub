...
JM_TXT = os.environ.get("PING_TEXT") or "قال النبـي صلى الله عليه وسلم : ( إنَّ اللَّهَ جَزَّأَ القُرْآنَ ثَلاثَةَ أجْزاءٍ، فَجَعَلَ {قُلْ هُوَ اللَّهُ أَحَدٌ} جُزْءًا مِن أجْزاءِ القُرْآن )."
