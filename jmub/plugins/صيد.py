...
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس دراكون : 
    ...
    try:
        ch = await jmub(
            functions.channels.CreateChannelRequest(
                title="DRAKON HUNTER - صيد دراكون",
                about="by - @PP_GX ",
            )
        )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    event.chat_id,
                    "https://t.me/PP_GX/73",
                    caption="🐊 DRAKON the best 🐊\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @PP_GX' - @PP_MX ❳ ".format(
...
async def _(event):
    ...
    try:
        ...
        try:
            ch = await jmub(
                functions.channels.CreateChannelRequest(
                    title="DRAKON HUNTER - تثبيت دراكون",
                    about="by - @PP_GX ",
                )
            )
            ch = ch.updates[1].channel_id
...
async def _(event):
    if "on" in isauto:
        ...
        await event.edit("-لقد حدث خطأ ما وتوقف الامر لديك")
t event.edit("-لقد حدث خطأ ما وتوقف الامر لديك")
