...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر دراكون
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmub.uid:
            buttons = [
                [Button.inline("معلومات دراكون", data="AOMRDB")],
                [
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس دراكون هذه بعض المعلومات عن دراكون:

- سورس دراكون يمتلك اكثر من 100 أمر 
- دراكون هو افضل سورس عربي يتميز بالحماية
...
ttons = [[Button.inline("رجوع", data="admincmd_s")]]
    await event.edit(ALIVEuncatm, buttons=buttons, link_preview=False)
