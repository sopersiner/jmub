...
async def _(event):
    ...
    channel_entity = await jmub.get_entity("@zmmbot")
    await jmub.send_message("@zmmbot", "/start")
    await asyncio.sleep(5)
    msg0 = await jmub.get_messages("@zmmbot", limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(5)
    msg1 = await jmub.get_messages("@zmmbot", limit=1)
    ...
    for i in range(100):
        ...
        try:
            ...
            msg2 = await jmub.get_messages("@zmmbot", limit=1)
