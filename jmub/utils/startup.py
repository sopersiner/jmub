...
LOGS = logging.getLogger("اعداد دراكون")
...
async def saves():
    ...
    try:
        ...
        await jmub(UnblockRequest("@PP_GX"))
        await jmub(
        ...
        await jmub.edit_folder("@PP_GX", folder=1)  # عمل ارشيف للبوت
        channel_usernames = ["PP_GX", "PP_HX", "PP_EX"]
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await jmub.send_message(
                "@PP_GX",
                "تم بنجاح تشغيل سورس دراكون عزيزي المستخدم هذا البوت سيتم تشغيله قريبا بعد اكماله",
            )
            await asyncio.sleep(1)
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_file(
                    ...
                    caption="**شكرا لتنصيبك سورس دراكون**\n • هنا بعض الملاحظات التي يجب ان تعرفها عن استخدامك لسورس دراكون.",
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_message(
                    BOTLOG_CHATID,
                    "**لقد تم بنجاح تنصيب سورس دراكون **\n➖➖➖➖➖➖➖➖➖➖\n**السورس**: @PP_GX\n**المطور**: @PP_MX\n➖➖➖➖➖➖➖➖➖➖\n**مجموعة الدعم**: @PP_GX\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        (Button.url("كروب المساعدة", "https://t.me/PP_HX"),)
                    ],
                )
        except Exception as e:
            LOGS.error(e)
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كروب بوت دراكون", jmub, Config.TG_BOT_USERNAME, descript, photobt
        )
